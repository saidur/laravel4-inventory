$(function() 
{
    $('.activate-branch').tooltip();

    $('#create-branch-form').on('submit', function()
    {
    ...
    $('#edit-branch-form').on('submit', function()
    {
        var sArray = $(this).serializeArray();
        $.ajax({
            "type": "PUT",
    ...
    $(document).on('click', '.delete-branch .confirm-action', function()
    {
